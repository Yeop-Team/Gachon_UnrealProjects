...
UE5로 제작한 가천대 중간고사 블루프린트 전용 슈팅 게임입니다.  
이 프로젝트는 **Blueprint만으로 구현**되어 있으며, `lody`, `load`, `game` 3개 맵을 기준으로 구성되어 있습니다.
...
- 플레이어_Red = {Speed : 500, HP : 100, Damge : 15}
- 플레이어_Blue = {Speed : 300, HP : 200, Damge : 10}
- 보스 생성 조건 = {1000점 달성 시 보스 생성}
